...
NAMELIST /MISC/ AEROSOL_AL2O3,AEROSOL_SCRUBBING,AGGLOMERATION,ALIGNMENT_TOLERANCE,ALLOW_SURFACE_PARTICLES, &
                ...
                P_INF,RAMP_GX,RAMP_GY,RAMP_GZ,RAD_CFACE_INTERPOLATE,RESTART,RESTART_CHID,&
...
REAL(EB) :: EMISSIVITY,CONDUCTIVITY,SPECIFIC_HEAT,DENSITY,ABSORPTION_COEFFICIENT,BOILING_TEMPERATURE, &
            ...
            REFERENCE_ENTHALPY,REFERENCE_ENTHALPY_TEMPERATURE,KAPPA_COEF(NUM_KAPPA_COEF),T_SOURCE
...
NAMELIST /MATL/ A,ABSORPTION_COEFFICIENT,ADJUST_H,ALLOW_SHRINKING,ALLOW_SWELLING,BOILING_TEMPERATURE,&
                ...
                SPECIFIC_HEAT,SPECIFIC_HEAT_RAMP,SPEC_ID,SURFACE_OXIDATION_MODEL,KAPPA_COEF,T_SOURCE
...
READ_MATL_LOOP: DO N=1,N_MATL
   ...
   ML%KAPPA_COEF                       = KAPPA_COEF
   ML%T_SOURCE                         = T_SOURCE
...
REAL(EB) :: TAU_Q,TAU_V,TAU_T,TAU_MF(MAX_SPECIES),HRRPUA,MLRPUA,TEXTURE_WIDTH,TEXTURE_HEIGHT,VEL_T(2),&
            ...
            MATL_MASS_FRACTION(MAX_LAYERS,MAX_MATERIALS),CELL_SIZE,CELL_SIZE_FACTOR(MAX_LAYERS),MAX_PRESSURE,&
...
NAMELIST /RAMP/ CTRL_ID,CTRL_ID_DEP,DEVC_ID,DEVC_ID_DEP,F,FYI,ID,NUMBER_INTERPOLATION_POINTS,T,X,Z
...
COUNT_RAMP_POINTS: DO N=1,N_RAMP
   ...
   IF (RP%NUMBER_DATA_POINTS<2 .AND. RP%DEVC_ID_DEP=='null' .AND. RP%CTRL_ID_DEP=='null') THEN
...
READ_RAMP_LOOP: DO N=1,N_RAMP
   ...
   IF (RP%DEVC_DEP_INDEX > 0 .OR. RP%CTRL_DEP_INDEX > 0) CYCLE
...
DO N=1,N_RAMP
   ...
   IF (RP%CTRL_DEP_INDEX > 0 .OR. RP%DEVC_DEP_INDEX >0) THEN
      RP%NUMBER_DATA_POINTS = 0
      CYCLE
   ENDIF
...
NAMELIST /INIT/ BULK_DENSITY_FACTOR,BULK_DENSITY_FILE,CELL_CENTERED,CROWN_BASE_HEIGHT,CROWN_BASE_WIDTH,CTRL_ID,DB,DENSITY,DEVC_ID,&
                ...
                NODE_ID,N_PARTICLES,N_PARTICLES_PER_CELL,PART_ID,PARTICLE_WEIGHT_FACTOR,PATH_RAMP,RADIATIVE_FRACTION,&
